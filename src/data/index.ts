...
export const accountTiles: AccountTiles = [
  {
    ...
    icon: Reports,
    path: 'GenerateReport',
    fields: ['date_to', 'date_from', 'territory_id', 'partner_id', 'region_id'],
    code: 'partner_ledger',
  ...
  {
    title: 'Account Status Area Wise Report',
    icon: Reports,
    path: 'GenerateReport',
    fields: [
      'date_to',
...
export const saleReports: AccountTiles = [
  ...
  },
  {
    ...
    icon: Reports,
    path: 'GenerateReport',
    fields: ['date_to', 'date_from', 'region_ids', 'territory_ids'],
  ...
  },
  {
    ...
    api_url: 'bm/product-sale/report',
  },
  {
    title: 'Product Ledger Summary Report',
    icon: Reports,
    path: 'GenerateReport',
    fields: [
      'date_to',
    ...
    optionalFields: ['territory_ids'],
    code: 'bm_product_ledger_summary_report',
    api_url: 'bm/product-ledger/report',
  },

  {
    title: 'Sale Analysis Report',
    icon: Reports,
    api_url: 'bm/sale-analysis/report',
    fields: [
      'date_to',
      'date_from',
      'region_ids',
